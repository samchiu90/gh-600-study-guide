# [Setting up GitHub Copilot for your enterprise](https://docs.github.com/api/article/body?pathname=/en/copilot/how-tos/copilot-on-github/set-up-copilot/enable-copilot/set-up-for-enterprise)
