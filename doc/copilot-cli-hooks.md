# [Using hooks with Copilot CLI for predictable, policy-compliant execution](https://docs.github.com/api/article/body?pathname=/en/copilot/tutorials/copilot-cli-hooks)
